...
namespace CatalogoJogos.Api.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoResponse>>> Obter([FromQuery, Range(1, int.MaxValue)] int pagina = 1, [FromQuery, Range(1, 50)] int quantidade = 5)
        {
        ...
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<JogoResponse>> Obter([FromRoute] Guid idJogo)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<JogoResponse>> InserirJogo([FromBody] JogoRequest jogoInputModel)
        {
            try
            {
        ...
        [HttpPut("{idJogo:guid}")]
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromBody] JogoRequest jogoInputModel)
        {
            try
            {
